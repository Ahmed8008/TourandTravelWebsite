...
export const Footer = () => {
  ...
  {/*2nd Part*/}
        <div className='space-y-5'>
            ...
            <p className='text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950'>Terms And Condition</p>
...
{/*4th Part*/}
        <div>
            ...
            <div className='mt-6'>
                ...
                <h1 className='text-base font-bold text-blue-950 mt-1'>+923360110359</h1>
                </div>
                 <div className='mt-6'>
                <h1 className='text-sm text-gray-600'> Our Email </h1>
                <h1 className='text-base font-bold text-blue-950 mt-1'>ahmedusmani643@gmail.com</h1>
                </div>
            </div>
        ...
        <div className='mt-8 w-[80%] mx-auto border-t pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm'>
            <p className='text-center md:text-left'> Copyright © 2025 all right reserved</p>
